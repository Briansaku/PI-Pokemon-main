...
export default function Card({ name, types, image, id, weight, height}){
    ...
    return (
      <div className={style.card} style={{ backgroundImage: `url(images/typesbkgm/${types[0]}.png)` }}>
        ...
        {sprite
          ? <img src={`images/sprites/${id}.gif`} alt="Image not found" height="190px" className={style.img} />
          : <img src={image} alt="Image not found" height="190px" className={style.img} />
        }
        ...
        <div className={style.about}>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              <span className={style.pokeweight}>{weight / 10}kg</span>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', paddingLeft: '24%' }}>
            <div style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              <span className={style.pokeheight}>{height / 10}m</span>
            </div>
